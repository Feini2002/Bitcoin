...
| Static shell / Worker HTTP | `index.html`, `js/app.js`, `js/data-engine.js`, `scripts/smoke-api.cjs` | `npm run verify:api`; `npm run diagnose` when Binance ↔ Worker probes matter |
